...
//post
const createPlan = async (req: Request, res: Response): Promise<Response> => {
  try {
    ...
    return res.status(400).json({
      message: "an error occurred while trying to create plan",
      data: error,
    });
  }
};
...
//get all
const getPlanned = async (req: Request, res: Response): Promise<Response> => {
  try {
...
export { createPlan, getOnePlanned, getPlanned };
